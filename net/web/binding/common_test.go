...
type (
	...
	handlerFunc func(interface{}, ...interface{}) web.Handler
...
func (p Post) Validate(ctx *web.Context, errs Errors) Errors {
	if len(p.Title) < 10 {
...
func (_ CustomErrorHandle) Error(_ *web.Context, _ Errors) {}
